...
trun=   1.00000E+00       #  Run length in years
tend=   1.00000E+00       #  Final time in years
...
noutoc=       2400       #  Output interval: ocean
noutat=       2400       #  Output interval: atmos.
nsko=          2          #  Subsampling interval for ocean output
...
gpoc=   1.50000E-02       #  Reduced gravity for ocean 1/2 interface
gpoc= [gpoc,   7.50000E-03]     #  Interfaces 2,n-1
...
cphsoc=   2.85349E+00     #  Baroclinic wavespeed for ocean mode 1
cphsoc= [cphsoc  , 1.62156E+00]     #  Higher modes
rdefoc=   3.04387E+04     #  Deformation radius for ocean mode 1
rdefoc= [rdefoc,   1.72975E+04]     #  Higher modes
